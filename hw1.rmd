...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Seungah Lee** and I am majoring *Agronomy* with a minor in *Data Science*. I want to become a data analyst aggregating my agricultural knowledge and build a career in the digital agricultural field. I am a person who loves traveling and enjoys playing the guitar during my spare time.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: Environmental data analysts have the role of identifying and tracking trends in what is happening in the natural world. Only the types of data are different, but not much different from what data analysts in other industries do. Data covered may include weather data, climate data, water quality data, etc. Environmental data analysts build a database of collected information and analyze it based on it to help clients make final decisions. You can get more detailed information by clicking on the picture below.
    
    <a href="https://www.theglobeandmail.com/report-on-business/careers/management/i-want-to-be-an-environmental-data-analyst-what-will-my-salary-be/article37092339/"><img src="https://www.theglobeandmail.com/resizer/bVub2POoxeXHrkyKAiGC3YBBQkI=/480x0/filters:quality(80)/arc-anglerfish-tgam-prod-tgam.s3.amazonaws.com/public/L7BNO2FXBZFKJDGVGTYCMUNR2Q.jpg" title="Environmental Data Analyst" width="600" height="400" /></a> 
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am interested in the data topics mainly addressed in agriculture and environmental science fields. Among them, dealing with geospatial data such as GIS is an area that I am most interested in. For example, digital soil mapping can be carried out based on the soil types and properties through data collection and analysis.
...
9. Configure your git username and user email by modifying and entering the following commands into the terminal
    ...
    ```
    git config --global user.name "Seungah Lee"
    git config --global user.email "seungah@iastate.edu"
    ```
